...
仓库根 `VERSION` 是项目版本的规范来源。当前版本 `0.8.5` 的 tag 为 `v0.8.5`，Release 必须同时包含：
...
bundle<TAB>core<TAB>vpsctl-core-0.8.5.tar.gz<TAB>SHA256
bundle<TAB>network<TAB>vpsctl-network-0.8.5.tar.gz<TAB>SHA256
bundle<TAB>system<TAB>vpsctl-system-0.8.5.tar.gz<TAB>SHA256
bundle<TAB>security<TAB>vpsctl-security-0.8.5.tar.gz<TAB>SHA256
bundle<TAB>service<TAB>vpsctl-service-0.8.5.tar.gz<TAB>SHA256
